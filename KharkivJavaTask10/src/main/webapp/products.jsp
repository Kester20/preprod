                                ...
                                <div class="view view-first">
                                    <div class="inner_content clearfix">
                                        <div class="product_image">
                                            <img src="img/acer2.jpg" class="img-responsive" alt=""/>
                                            <div class="mask">
                                                <div class="info">Quick View</div>
                                            </div>
                                            <div class="product_container">
                                                <div class="cart-left">
                                                    <p class="title">Acer</p>
                                                </div>
                                                <div class="pricey"><span class="item_price">$1000</span></div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <a class="cbp-vm-image" href="single.jsp">
                    <div class="simpleCart_shelfItem">
                        <div class="view view-first">
                            <div class="inner_content clearfix">
                                <div class="product_image">
                                    <img src="img/acer3.jpg" class="img-responsive" alt=""/>
                                    <div class="mask">
                                        <div class="info">Quick View</div>
                                    </div>
                                    <div class="product_container">
                                        ...
                                        <div class="pricey"><span class="item_price">$1200</span></div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="inner_content clearfix">
                            <div class="product_image">
                                ...
                                <div class="product_container">
                                    ...
                                    <div class="pricey"><span class="item_price">$1900</span></div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
                        </div>
        ...
        <a class="cbp-vm-image" href="single.jsp">
            <div class="simpleCart_shelfItem">
                <div class="view view-first">
                    <div class="inner_content clearfix">
                        <div class="product_image">
                            <img src="img/hp.jpg" class="img-responsive" alt=""/>
                            <div class="mask">
                                <div class="info">Quick View</div>
                            </div>
                            <div class="product_container">
                                ...
                                <div class="pricey"><span class="item_price">$1300</span></div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                    </div>
    ...
    <a class="cbp-vm-image" href="single.jsp">
        <div class="simpleCart_shelfItem">
            <div class="view view-first">
                <div class="inner_content clearfix">
                    <div class="product_image">
                        <img src="img/hp2.jpg" class="img-responsive" alt=""/>
                        <div class="mask">
                            <div class="info">Quick View</div>
                        </div>
                        <div class="product_container">
    ...
    <a class="cbp-vm-image" href="single.jsp">
        <div class="simpleCart_shelfItem">
            <div class="view view-first">
                <div class="inner_content clearfix">
                    <div class="product_image">
                        <img src="img/hp06.jpg" class="img-responsive" alt=""/>
                        <div class="mask">
                            <div class="info">Quick View</div>
                        </div>
                        <div class="product_container">
    ...
    <a class="cbp-vm-image" href="single.jsp">
        <div class="simpleCart_shelfItem">
            <div class="view view-first">
                <div class="inner_content clearfix">
                    <div class="product_image">
                        <img src="img/len.png" class="img-responsive" alt=""/>
                        <div class="mask">
                            <div class="info">Quick View</div>
                        </div>
                        <div class="product_container">
    ...
    <a class="cbp-vm-image" href="single.jsp">
        <div class="simpleCart_shelfItem">
            <div class="view view-first">
                <div class="inner_content clearfix">
                    <div class="product_image">
                        <img src="img/oi.jpg" class="img-responsive" alt=""/>
                        <div class="mask">
                            <div class="info">Quick View</div>
                        </div>
                        <div class="product_container">
    ...
    <a class="cbp-vm-image" href="single.jsp">
        <div class="simpleCart_shelfItem">
            <div class="view view-first">
                <div class="inner_content clearfix">
                    <div class="product_image">
                        <img src="img/sams.jpg" class="img-responsive" alt="" style="width:200px"/>
                        <div class="mask">
                            <div class="info">Quick View</div>
                        </div>
                        <div class="product_container">
                            ...
                            <div class="pricey"><span class="item_price">$1500</span></div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
