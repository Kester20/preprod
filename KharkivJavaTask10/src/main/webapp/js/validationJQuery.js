...
function invokeAllFunctions(){
    ...
    var callbacks = [
      function() { return isNotEmptyInput(document.registerForm.firstName); },
      function() { return isNotEmptyInput(document.registerForm.lastName); },
      function() { return checkLengthPassword(document.registerForm.pass); },
      function() { return validateEmail(document.registerForm.email); },
      function() { return validatePhone(document.registerForm.mobileNumber); },
      function() { return checkStringEquals(document.registerForm.pass, document.registerForm.pass2); }
    ];
