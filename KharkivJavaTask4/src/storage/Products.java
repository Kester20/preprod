...
public class Products {
    ...
    private static List<Product> list = new ArrayList<Product>() {{
        add(new Laptop(1, "Aer1", 15000, "Acer", 15.6));
        add(new Laptop(2, "Bvc", 10000, "Samsung", 15.6));
        add(new Laptop(3, "NBc", 25000, "Apple", 15.6));
        add(new Laptop(4, "ART", 15000, "Asus", 15.6));
        add(new Laptop(5, "Aqq", 20000, "Dell", 15.6));
        add(new Laptop(6, "Aqq", 20000, "Dell", 15.6));
        add(new Laptop(7, "Aqq", 20000, "Dell", 15.6));
        add(new Laptop(8, "Aqq", 20000, "Dell", 15.6));
    }};
